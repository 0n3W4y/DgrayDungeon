...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_innwindowherobutton_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_recruitwindowhero_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_recruitwindowherolevel_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_recruitwindowheropicture_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("Assets/images/innWindowHeroButton.png") @:noCompletion #if display private #end class __ASSET__assets_images_innwindowherobutton_png extends lime.graphics.Image {}
...
@:keep @:image("Assets/images/recruitWindowHero.png") @:noCompletion #if display private #end class __ASSET__assets_images_recruitwindowhero_png extends lime.graphics.Image {}
@:keep @:image("Assets/images/recruitWindowHeroLevel.png") @:noCompletion #if display private #end class __ASSET__assets_images_recruitwindowherolevel_png extends lime.graphics.Image {}
@:keep @:image("Assets/images/recruitWindowHeroPicture.png") @:noCompletion #if display private #end class __ASSET__assets_images_recruitwindowheropicture_png extends lime.graphics.Image {}
