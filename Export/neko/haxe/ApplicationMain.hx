...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DgrayDungeon", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DgrayDungeon", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.sample.dgraydungeon";
