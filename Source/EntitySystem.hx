...
class EntitySystem
{
	...
	private function _createButton( type:String, name:String, id:Int ):Entity
	{
	...
	public function createEntity( type:String, name:String ):Entity
	{
		var id = this._createId();
		switch( type )
		{
			case "button" : return this._createButton( type, name, id );
